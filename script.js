function initQuiz() {
    ...
    //  Start
        ...
        let highScores = [];
            ...
            //  Used to retrive the highscores from local storage
                ...
                function startQuiz() {
                    ...
                    function generateQuestion(questionNum) {
                        ...
                        for (let i=0; i<4; i++) {
                            ...
                            buttonEl.setAttribute("class","btn btn-warning");
                            ...
                            buttonEl.addEventListener("click",function(){
                                ...
                                // Once an answer is selected it will respond 'Nice Job!' (if correct), and Wrong Answer (if wrong)
                                clickTimeout = true;
                                clearInterval(myInterval);
                                ...
                                if (this.innerHTML === questions[currentQuestion - 1].answer) {
                                    parEl.innerHTML = "Nice Job!";
                                } else {
                                    parEl.innerHTML = "Wrong Answer";
                                    // Wrong Answers will deduct 10 seconds from the time
                                ...
                                setTimeout(function() {
                                        // setTimeout will delays the next question by 2 seconds after answering
                                    if (currentQuestion>questions.length) {
                                        quizContainerEl.setAttribute("class","container d-none");
                                        finalContainerEl.setAttribute("class","container");
